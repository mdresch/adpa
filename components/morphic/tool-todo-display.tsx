...
import type { Part, TodoItem, ToolPart } from '@/lib/morphic/types/ai'
...
export function ToolTodoDisplay({
    ...
    const openInspector = () => {
        ...
        const part: Part = {
            ...
            toolCallId,
            state,
            input: { todos: (output.todos || []) as TodoItem[] },
            output
                ...
                <div className="flex">
                    ...
                    <div className="flex-1">
                        {state === 'output-available' ? (
                            ...
                            <div className="px-3 pb-3 text-xs text-destructive">{`Todo tool failed${output && 'message' in output && output.message
                                    ? `: ${output.message}`
                                    : ''
                                }`}</div>
                        ) : null}
