...
import { shareChat } from '@/lib/morphic/actions/chat'
import { useCopyToClipboard } from '@/lib/morphic/hooks/use-copy-to-clipboard'
...
export function ChatShare({ chatId, className }: ChatShareProps) {
    ...
    const handleShare = async () => {
        ...
        const url = new URL(
            `/morphic/search/${sharedChatObject.id}`,
