...
const ContextMenuSubTrigger = React.forwardRef(function ContextMenuSubTrigger(
  { className, inset, children, ...props }: React.ComponentPropsWithoutRef<'button'> & { inset?: boolean },
...
const ContextMenuItem = React.forwardRef(function ContextMenuItem(
  { className, inset, ...props }: React.ComponentPropsWithoutRef<'div'> & { inset?: boolean },
  ref: React.ForwardedRef<HTMLDivElement>
) {
  return (
...
const ContextMenuCheckboxItem = React.forwardRef(function ContextMenuCheckboxItem(
  { className, children, checked, ...props }: React.ComponentPropsWithoutRef<'div'>,
  ref: React.ForwardedRef<HTMLDivElement>
) {
  return (
