...
import { Check, ChevronRight, Circle } from "./icons-shim"
...
const DropdownMenuSubTrigger = React.forwardRef(function DropdownMenuSubTrigger(
  props: React.ComponentPropsWithoutRef<"button"> & { inset?: boolean },
...
const DropdownMenuContent = React.forwardRef(function DropdownMenuContent(
  props: React.ComponentPropsWithoutRef<"div"> & { sideOffset?: number },
  ref: React.ForwardedRef<HTMLDivElement>
) {
...
const DropdownMenuItem = React.forwardRef(function DropdownMenuItem(
  props: React.ComponentPropsWithoutRef<"div"> & { inset?: boolean },
  ref: React.ForwardedRef<HTMLDivElement>
) {
