...
-- Resolves "GKG unavailable" error by providing the missing aggregation function for template-specific entity counts.
...
-- Grant permissions if necessary (adjust based on your security model)
-- GRANT EXECUTE ON FUNCTION public.get_all_entity_counts_for_template(uuid) TO public;
