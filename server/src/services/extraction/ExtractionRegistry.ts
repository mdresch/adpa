...
export async function initializeRegistry(): Promise<void> {
  ...
  const { extractWorkItems, saveWorkItems } = await import('./entities/work_items/index.js')
  ...
  const { extractCapacityPlans, saveCapacityPlans } = await import('./entities/capacity_plans/index.js')
  ...
  const { extractPerformanceMeasurements, savePerformanceMeasurements } = await import('./entities/performance_measurements/index.js')
  ...
  const { extractEarnedValueMetrics, saveEarnedValueMetrics } = await import('./entities/earned_value_metrics/index.js')
  ...
  const { extractOpportunities, saveOpportunities } = await import('./entities/opportunities/index.js')
  ...
  const { extractRiskResponses, saveRiskResponses } = await import('./entities/risk_responses/index.js')
  ...
  const { extractPerformanceActuals, savePerformanceActuals } = await import('./entities/performance_actuals/index.js')
  ...
  const { extractStakeholders, saveStakeholders } = await import('./entities/stakeholders/index.js')
  ...
  const { extractRequirements, saveRequirements } = await import('./entities/requirements/index.js')
  ...
  const { extractRisks, saveRisks } = await import('./entities/risks/index.js')
  ...
  const { extractMilestones, saveMilestones } = await import('./entities/milestones/index.js')
  ...
  const { extractConstraints, saveConstraints } = await import('./entities/constraints/index.js')
  ...
  const { extractActivities, saveActivities } = await import('./entities/activities/index.js')
  ...
  const { extractDeliverables, saveDeliverables } = await import('./entities/deliverables/index.js')
  ...
  const { extractScopeItems, saveScopeItems } = await import('./entities/scope_items/index.js')
  ...
  const { extractSuccessCriteria, saveSuccessCriteria } = await import('./entities/success_criteria/index.js')
  ...
  const { extractPhases, savePhases } = await import('./entities/phases/index.js')
  ...
  const { extractProjectIterations, saveProjectIterations } = await import('./entities/project_iterations/index.js')
  ...
  const { extractBestPractices, saveBestPractices } = await import('./entities/best_practices/index.js')
  ...
  const { extractResources, saveResources } = await import('./entities/resources/index.js')
  ...
  const { extractTechnologies, saveTechnologies } = await import('./entities/technologies/index.js')
  ...
  const { extractQualityStandards, saveQualityStandards } = await import('./entities/quality_standards/index.js')
  ...
  const { extractTeamAgreements, saveTeamAgreements } = await import('./entities/team_agreements/index.js')
  ...
  const { extractDevelopmentApproaches, saveDevelopmentApproaches } = await import('./entities/development_approaches/index.js')
  ...
  const { extractGovernanceDecisions, saveGovernanceDecisions } = await import('./entities/governance_decisions/index.js')
  ...
  const { extractApprovalWorkflows, saveApprovalWorkflows } = await import('./entities/approval_workflows/index.js')
  ...
  const { extractSteeringCommittees, saveSteeringCommittees } = await import('./entities/steering_committees/index.js')
  ...
  const { extractChangeControlBoards, saveChangeControlBoards } = await import('./entities/change_control_boards/index.js')
  ...
  const { extractPolicyCompliance, savePolicyCompliance } = await import('./entities/policy_compliance/index.js')
  ...
  const { extractScopeBaseline, saveScopeBaseline } = await import('./entities/scope_baseline/index.js')
  ...
  const { extractWBSNodes, saveWBSNodes } = await import('./entities/wbs_nodes/index.js')
  ...
  const { extractScopeChangeRequests, saveScopeChangeRequests } = await import('./entities/scope_change_requests/index.js')
  ...
  const { extractRequirementsTraceability, saveRequirementsTraceability } = await import('./entities/requirements_traceability/index.js')
  ...
  const { extractScopeVerification, saveScopeVerification } = await import('./entities/scope_verification/index.js')
  ...
  const { extractDtAssets, saveDtAssets } = await import('./entities/dt_assets/index.js')
  ...
  const { extractScheduleBaseline, saveScheduleBaseline } = await import('./entities/schedule_baseline/index.js')
  ...
  const { extractScheduleActivities, saveScheduleActivities } = await import('./entities/schedule_activities/index.js')
  ...
  const { extractCriticalPath, saveCriticalPath } = await import('./entities/critical_path/index.js')
  ...
  const { extractScheduleVariances, saveScheduleVariances } = await import('./entities/schedule_variances/index.js')
  ...
  const { extractScheduleForecasts, saveScheduleForecasts } = await import('./entities/schedule_forecasts/index.js')
  ...
  const { extractBudgetBaseline, saveBudgetBaseline } = await import('./entities/budget_baseline/index.js')
  ...
  const { extractCostActuals, saveCostActuals } = await import('./entities/cost_actuals/index.js')
  ...
  const { extractCostEstimates, saveCostEstimates } = await import('./entities/cost_estimates/index.js')
  ...
  const { extractFundingTranches, saveFundingTranches } = await import('./entities/funding_tranches/index.js')
  ...
  const { extractFinancialVariances, saveFinancialVariances } = await import('./entities/financial_variances/index.js')
  ...
  const { extractProcurementCosts, saveProcurementCosts } = await import('./entities/procurement_costs/index.js')
  ...
  const { extractResourcePlans, saveResourcePlans } = await import('./entities/resource_plans/index.js')
  ...
  const { extractRolesAndResponsibilities, saveRolesAndResponsibilities } = await import('./entities/roles_and_responsibilities/index.js')
  ...
  const { extractTeamAvailability, saveTeamAvailability } = await import('./entities/team_availability/index.js')
  ...
  const { extractLaborRates, saveLaborRates } = await import('./entities/labor_rates/index.js')
  ...
  const { extractProjectOrgChart, saveProjectOrgChart } = await import('./entities/project_org_chart/index.js')
  ...
  const { extractResourceAssignments, saveResourceAssignments } = await import('./entities/resource_assignments/index.js')
  ...
  const { extractResourcePool, saveResourcePool } = await import('./entities/resource_pool/index.js')
  ...
  const { extractCapacityForecasts, saveCapacityForecasts } = await import('./entities/capacity_forecasts/index.js')
  ...
  const { extractUtilizationRecords, saveUtilizationRecords } = await import('./entities/utilization_records/index.js')
  ...
  const { extractResourceConflicts, saveResourceConflicts } = await import('./entities/resource_conflicts/index.js')
  ...
  const { extractOnboardingOffboarding, saveOnboardingOffboarding } = await import('./entities/onboarding_offboarding/index.js')
  ...
  const { extractRiskAppetite, saveRiskAppetite } = await import('./entities/risk_appetite/index.js')
  ...
  const { extractRiskChecklists, saveRiskChecklists } = await import('./entities/risk_checklists/index.js')
  ...
  const { extractProbabilityImpactMatrix, saveProbabilityImpactMatrix } = await import('./entities/probability_impact_matrix/index.js')
  ...
  const { extractRiskAssessments, saveRiskAssessments } = await import('./entities/risk_assessments/index.js')
  ...
  const { extractRiskResponsePlans, saveRiskResponsePlans } = await import('./entities/risk_response_plans/index.js')
  ...
  const { extractRiskTriggers, saveRiskTriggers } = await import('./entities/risk_triggers/index.js')
  ...
  const { extractRiskReviews, saveRiskReviews } = await import('./entities/risk_reviews/index.js')
  ...
  const { extractContingencyReserves, saveContingencyReserves } = await import('./entities/contingency_reserves/index.js')
  ...
  const { extractRiskMetrics, saveRiskMetrics } = await import('./entities/risk_metrics/index.js')
  ...
  const { extractIssueLog, saveIssueLog } = await import('./entities/issue_log/index.js')
  ...
  const { extractLessonsLearned, saveLessonsLearned } = await import('./entities/lessons_learned/index.js')
  ...
  const { extractStakeholderEngagements, saveStakeholderEngagements } = await import('./entities/stakeholder_engagements/index.js')
  ...
  const { extractCommunicationLogs, saveCommunicationLogs } = await import('./entities/communication_logs/index.js')
  ...
  const { extractEngagementActions, saveEngagementActions } = await import('./entities/engagement_actions/index.js')
  ...
  const { extractSatisfactionSurveys, saveSatisfactionSurveys } = await import('./entities/satisfaction_surveys/index.js')
  ...
  const { extractStakeholderIssues, saveStakeholderIssues } = await import('./entities/stakeholder_issues/index.js')
  ...
  const { extractRelationshipHealth, saveRelationshipHealth } = await import('./entities/relationship_health/index.js')
  ...
  const { extractActionItems, saveActionItems } = await import('./entities/action_items/index.js')
  ...
  const { extractMeetingMinutes, saveMeetingMinutes } = await import('./entities/meeting_minutes/index.js')
  ...
  const { extractProjectCharterDetails, saveProjectCharterDetails } = await import('./entities/project_charter_details/index.js')
  ...
  const { extractBusinessCaseDetails, saveBusinessCaseDetails } = await import('./entities/business_case_details/index.js')
  ...
  const { extractBenefitRealizationPlan, saveBenefitRealizationPlan } = await import('./entities/benefit_realization_plan/index.js')
  ...
  const { extractGeneralChangeRequests, saveGeneralChangeRequests } = await import('./entities/general_change_requests/index.js')
  ...
  const { extractProjectTeamEvaluations, saveProjectTeamEvaluations } = await import('./entities/project_team_evaluations/index.js')
