-- Migration: Update User Personas Motivation Assessment Template to Produce Markdown Output
-- Description: Updates the existing User Personas Motivation Assessment template to ensure it generates Markdown format instead of JSON
-- Date: 2026-02-03
-- Version: 1.0.0

-- Update the User Personas Motivation Assessment template to enforce Markdown output
UPDATE templates 
SET 
