-- Context Bundle Additional Tables
-- Creates additional tables for context bundle management and analytics
...
BEGIN
    ...
    FOR bundle_id_val IN SELECT DISTINCT id FROM context_bundles
    LOOP
...
CREATE OR REPLACE FUNCTION cleanup_expired_context_bundle_insights()
RETURNS VOID AS $$
BEGIN
    -- Delete expired insights
    DELETE FROM context_bundle_insights 
    ...
    INSERT INTO context_bundle_processing_history (
        ...
        '00000000-0000-0000-0000-000000000000'::uuid, 'cleanup', 'completed', NOW(), NOW()
    );
END;
$$ LANGUAGE plpgsql;
