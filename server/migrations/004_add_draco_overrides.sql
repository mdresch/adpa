...
--
-- Merged in the DRACO review schema (originally add_draco_review_schema.sql,
-- which lacked the numeric prefix run-migrations.ts requires and was
-- therefore never being applied) so draco_reviews exists before this file's
-- FK reference to it.

-- ────────────────────────────────────────────────────────────────────────────────
-- 0. DRACO Reviews Table (main review results) + supporting schema
-- ────────────────────────────────────────────────────────────────────────────────
