...
export default function AssessmentsListPage() {
  ...
  const [selectedProcessingAssessment, setSelectedProcessingAssessment] = React.useState<Assessment | null>(null);
  const [sortColumn, setSortColumn] = React.useState<keyof Assessment | null>(null);
  const [sortDirection, setSortDirection] = React.useState<'asc' | 'desc'>('desc');

  // Bulk operations
  const [selectedAssessments, setSelectedAssessments] = React.useState<Set<string>>(new Set());
  ...
  const [filterMaturityMin, setFilterMaturityMin] = React.useState<number | ''>('');
  const [filterMaturityMax, setFilterMaturityMax] = React.useState<number | ''>('');
