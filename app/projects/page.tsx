...
export default function Projects() {
  const [projects] = useState([
    ...
    },
    {
      ...
      description: "Implementation of enterprise-wide data governance framework and policies",
      status: "planning",
      progress: 25,
      startDate: "2024-02-01",
      endDate: "2024-12-31",
      manager: "Robert Chen",
      team: ["Alice Brown", "David Lee"],
      documentsCount: 8,
      framework: "DMBOK 2.0",
    ...
    {
      id: "3",
      name: "Requirements Analysis - ERP System",
      description: "Comprehensive business requirements analysis for new ERP system implementation",
      status: "active",
      progress: 80,
      startDate: "2023-11-01",
      endDate: "2024-03-15",
      manager: "Lisa Wang",
      team: ["Tom Anderson", "Emma Davis", "Chris Taylor", "Amy Johnson"],
      documentsCount: 24,
      framework: "BABOK v3",
                    ...
                    <Card className="glass border-0 shadow-lg hover:shadow-2xl transition-all duration-300 group overflow-hidden">
                      ...
                      <CardContent className="relative space-y-6">
                        <div>
                          ...
                          >
                            <Progress value={project.progress} className="h-3 bg-slate-100 dark:bg-slate-700">
                              <motion.div
                                initial={{ width: 0 }}
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200 dark:border-slate-700">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xs text-slate-500 dark:text-slate-400">{project.lastActivity}</span>
                          </div>
                          <motion.div
