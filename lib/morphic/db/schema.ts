...
export const aiProviders = pgTable(
    'ai_providers',
    {
        ...
        type: varchar('type', { length: VARCHAR_LENGTH }).notNull().default('openai'),
        baseUrl: text('base_url'),
        apiKey: text('api_key'),
        isEnabled: integer('is_enabled').notNull().default(1), // 1 for true, 0 for false
...
export const aiModels = pgTable(
    'ai_models',
    {
        ...
        name: varchar('name', { length: VARCHAR_LENGTH }).notNull(),
        modelId: varchar('model_id', { length: VARCHAR_LENGTH }).notNull(),
...
export const aiModelConfig = pgTable(
    'ai_model_config',
    {
        ...
        modelType: varchar('model_type', {
            length: VARCHAR_LENGTH,
            enum: ['speed', 'quality', 'related_questions']
        }).notNull(),
        modelId: varchar('model_id', { length: ID_LENGTH })
            .notNull()
