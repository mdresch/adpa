...
class DocumentProcessor {
    ...
    async extractText(file, type) {
        try {
            ...
            logger_1.logger.log('error', 'Failed to extract text from document', {
                type,
                error: error.message
            });
            throw error;
     ...
     */
    async processDocument(content, documentId, type, chunkSize = 1000, overlap = 200) {
        (0, logger_1.logDocumentProcessing)(documentId, 'chunking', {
        ...
        (0, logger_1.logDocumentProcessing)(documentId, 'chunking_completed', {
