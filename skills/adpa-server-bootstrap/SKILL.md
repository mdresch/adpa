---
name: adpa-server-bootstrap
description: Manages the server startup sequence, dependency initialization, and health checks. Use this skill to understand, debug, or extend the server's bootstrap process, including adding new dependencies, configuring timeouts, and integrating with monitoring systems.
---
...
`✓ CRITICAL SECURITY WARNING: NODE_TLS_REJECT_UNAUTHORIZED=0 is set in production. This bypasses TLS verification and is highly unsafe. Startup aborted.`
